...
type TwitterAuthorizeURLResp struct {
	...
	Url string `protobuf:"bytes,1,opt,name=url,proto3" json:"url,omitempty"` // 授权 URL
}
...
type TwitterSignInReq struct {
	...
	AuthorizationCode string `protobuf:"bytes,1,opt,name=authorization_code,json=authorizationCode,proto3" json:"authorization_code,omitempty"` // 前端获取的授权码
}
...
type TwitterSignInResp struct {
	...
	IsNew    bool   `protobuf:"varint,1,opt,name=is_new,json=isNew,proto3" json:"is_new,omitempty"`         // 是否是新用户
	UserId   int64  `protobuf:"varint,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`      // 用户id
	Token    string `protobuf:"bytes,3,opt,name=token,proto3" json:"token,omitempty"`                       // 生成的会话 token
...
var file_business_ext_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x8e, 0x02, 0x0a, 0x04, 0x55,
	...
	,
	...
	0x72, 0x0a, 0x0d, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71,
	...
	0x73, 0x65, 0x78, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x73, 0x65, 0x78, 0x12, 0x1d,
	...
	0x74, 0x72, 0x61, 0x22, 0x21, 0x0a, 0x0d, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x55, 0x73, 0x65,
	0x72, 0x52, 0x65, 0x71, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x22, 0x30, 0x0a, 0x0e, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68,
	...
	0x72, 0x52, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x22, 0x2b, 0x0a, 0x17, 0x54, 0x77, 0x69, 0x74,
	...
	0x52, 0x03, 0x75, 0x72, 0x6c, 0x22, 0x41, 0x0a, 0x10, 0x54, 0x77, 0x69, 0x74, 0x74, 0x65, 0x72,
	0x53, 0x69, 0x67, 0x6e, 0x49, 0x6e, 0x52, 0x65, 0x71, 0x12, 0x2d, 0x0a, 0x12, 0x61, 0x75, 0x74,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x64, 0x65, 0x22, 0x80, 0x01, 0x0a, 0x11, 0x54, 0x77, 0x69,
	0x74, 0x74, 0x65, 0x72, 0x53, 0x69, 0x67, 0x6e, 0x49, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x12, 0x15,
	...
	0x6f, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x08, 0x2e, 0x70, 0x62, 0x2e, 0x55, 0x73, 0x65,
	0x72, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x32, 0xdd, 0x02, 0x0a, 0x0b,
	0x42, 0x75, 0x73, 0x69, 0x6e, 0x65, 0x73, 0x73, 0x45, 0x78, 0x74, 0x12, 0x27, 0x0a, 0x06, 0x53,
	...
	0x52, 0x65, 0x73, 0x70, 0x12, 0x2a, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x12,
	0x0e, 0x2e, 0x70, 0x62, 0x2e, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x1a,
	0x0f, 0x2e, 0x70, 0x62, 0x2e, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70,
	0x12, 0x37, 0x0a, 0x0a, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x12, 0x11,
	0x2e, 0x70, 0x62, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65,
	0x71, 0x1a, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x33, 0x0a, 0x0a, 0x53, 0x65, 0x61,
	...
	,
...
var file_business_ext_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_business_ext_proto_goTypes = []any{
	...
	(*TwitterAuthorizeURLResp)(nil), // 8: pb.TwitterAuthorizeURLResp
	(*TwitterSignInReq)(nil),        // 9: pb.TwitterSignInReq
	(*TwitterSignInResp)(nil),       // 10: pb.TwitterSignInResp
...
var file_business_ext_proto_depIdxs = []int32{
	...
	2,  // 2: pb.TwitterSignInResp.user_info:type_name -> pb.User
	0,  // 3: pb.BusinessExt.SignIn:input_type -> pb.SignInReq
	3,  // 4: pb.BusinessExt.GetUser:input_type -> pb.GetUserReq
	5,  // 5: pb.BusinessExt.UpdateUser:input_type -> pb.UpdateUserReq
	6,  // 6: pb.BusinessExt.SearchUser:input_type -> pb.SearchUserReq
	11, // 7: pb.BusinessExt.GetTwitterAuthorizeURL:input_type -> google.protobuf.Empty
	9,  // 8: pb.BusinessExt.TwitterSignIn:input_type -> pb.TwitterSignInReq
	1,  // 9: pb.BusinessExt.SignIn:output_type -> pb.SignInResp
	4,  // 10: pb.BusinessExt.GetUser:output_type -> pb.GetUserResp
	11, // 11: pb.BusinessExt.UpdateUser:output_type -> google.protobuf.Empty
	7,  // 12: pb.BusinessExt.SearchUser:output_type -> pb.SearchUserResp
	8,  // 13: pb.BusinessExt.GetTwitterAuthorizeURL:output_type -> pb.TwitterAuthorizeURLResp
	10, // 14: pb.BusinessExt.TwitterSignIn:output_type -> pb.TwitterSignInResp
